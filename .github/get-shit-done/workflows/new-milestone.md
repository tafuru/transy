...
node ".github/get-shit-done/bin/gsd-tools.cjs" config-set workflow.research true

# If "Skip research": persist false
node ".github/get-shit-done/bin/gsd-tools.cjs" config-set workflow.research false
```
